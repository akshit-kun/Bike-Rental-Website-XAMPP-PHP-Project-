        ...
        <div class="sidebar_widget">
          ...
          <form method="post">
            <div class="form-group">
              ...
              <input type="text" name="fromdate" id="fromdate" class="form-control" placeholder="From Date" required readonly>
            </div>
            <div class="form-group">
              <label>To Date</label>
              <input type="text" name="todate" id="todate" class="form-control" placeholder="To Date" required readonly>
            </div>
            <div class="form-group">
